...
test("loopStream", function () {
    var sa = new Sodium_1.StreamSink(), sc = Sodium_1.run(function () {
...
test("loopCell", function () {
    var sa = new Sodium_1.StreamSink(), sum_out = Sodium_1.run(function () {
...
test("loopValueSnapshot", function () {
    var out = [], kill = Sodium_1.run(function () {
...
test("loopValueHold", function () {
    var out = [], value = Sodium_1.run(function () {
...
test("liftLoop", function () {
    var out = [], b = new Sodium_1.CellSink("kettle"), c = Sodium_1.run(function () {
